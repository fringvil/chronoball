# Chronoball TODO
## Check
- [x] Implement different scenes according to common practises. Loading Screen, a Main Menu, a Game Level, an in-game Item Shop, a High Score Table (https://docs.phaser.io/phaser/concepts/scenes)
- [x] Implement arcade physics (https://docs.phaser.io/phaser/concepts/physics/arcade)
